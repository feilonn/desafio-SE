...
public class ItemPedidoTest {
    ...
    public void testGetterAndSetter() {
        ItemPedido itemPedido = new ItemPedido("Livro", 20.0);

        assertThat(itemPedido.getTituloItem()).isEqualTo("Livro");
        assertThat(itemPedido.getValorItem()).isEqualTo(20.0);
    }
    ...
    public void testEquals() {
        ItemPedido itemPedido1 = new ItemPedido("Livro", 20.0);
        ItemPedido itemPedido2 = new ItemPedido("Livro", 20.0);
        ItemPedido itemPedido3 = new ItemPedido("Caneta", 5.0);
