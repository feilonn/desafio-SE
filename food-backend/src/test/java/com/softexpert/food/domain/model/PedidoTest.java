...
public class PedidoTest {
    ...
    public void testToString() {
        List<ItemPedido> itensPedido = new ArrayList<>();
        itensPedido.add(new ItemPedido("Livro", 20.0));
    ...
    public void testEquals() {
        ...
        itensPedido1.add(new ItemPedido("Livro", 20.0));

        List<ItemPedido> itensPedido2 = new ArrayList<>();
        itensPedido2.add(new ItemPedido("Livro", 20.0));

        List<ItemPedido> itensPedido3 = new ArrayList<>();
        itensPedido3.add(new ItemPedido("Caneta", 5.0));
